return {
  ...
  config = function()
    ...
    local servers = {
      ...
      ts_ls = {
        cmd = "/home/stefan/.local/share/nvim/mason/bin/typescript-language-server",
        filetypes = {
          "javascript",
          "typescript",
        },
    ...
    vim.api.nvim_create_user_command(
      ...
      function(args)
        ...
        local function trigger_daily_note()
        ...
        if #clients > 0 then
          ...
          vim.api.nvim_buf_set_name(buf, vault_path .. "/__init_oxide.md")

          -- 4. Set filetype to trigger the LSP start
          ...
          vim.api.nvim_create_autocmd("LspAttach", {
            ...
            callback = function(ev)
              ...
              if client.name == "markdown_oxide" then
                -- Wait a tiny bit for the server to index, then jump
                vim.defer_fn(trigger_daily_note, 100)
              end
            end
          })
