...
vim.keymap.set("n", "<C-h>", function()
	require("config.search-and-replace.builtin").search_and_replace({})
end, {})
vim.keymap.set("v", "<C-h>", function()
	require("config.search-and-replace.builtin").search_and_replace({ visual = true })
end, {})

vim.api.nvim_set_keymap("c", "<C-b>", "example", { noremap = true })
